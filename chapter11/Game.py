from tkinter import Canvas, Label, Tk, StringVar, ALL, PhotoImage
from tkinter import messagebox
from collections import Counter
from chapter11.Block import Block
...
class Game:
    def __init__(self):
        ...
        # ブロックを作成する前に利用する画像を生成しておく
        self.create_block_images()

    def create_block_images(self):
        for block in BLOCKS:
            filename = block[0]
            BLOCK_IMAGES[filename] = PhotoImage(file="./../images/" + filename)
    ...
    def remove_complete_lines(self):
        ...
        for box in self.current_block.boxes:
            ...
            block_boxes_coords.append(self.canvas.coords(box)[1])
        ...
        for box in all_boxes:
            all_boxes_y.append(self.canvas.coords(box)[1])
